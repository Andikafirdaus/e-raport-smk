...
@php
    ...
    $jurusan  = $rombel && isset($rombel->kelas->jurusan) ? $rombel->kelas->jurusan->nama_jurusan : '-';
    $bidang   = $rombel && isset($rombel->kelas->jurusan) ? $rombel->kelas->jurusan->singkatan : '-';
...
<div class="page">
    ...
    <div class="header">
        <div class="logo">
            <img src="{{ asset('img/logo-smk.png') }}" alt="Logo SMK" onerror="this.style.display='none'">
        </div>
    ...
    <table class="nilai-table" style="margin-top:6px;">
        ...
        <tbody>
            {{-- ===== KELOMPOK A: 6 mapel pertama ===== --}}
            <tr><td colspan="6" class="group-header">A. &nbsp; KELOMPOK A ( WAJIB )</td></tr>
            @php $kelompokA = $nilais->take(6); $noA = 1; @endphp
            ...
            {{-- ===== KELOMPOK B: index ke-7 & ke-8 dari database ===== --}}
            <tr><td colspan="6" class="group-header">B. &nbsp; KELOMPOK B ( WAJIB )</td></tr>
            @php $kelompokB = $nilais->slice(6, 2); $noB = 1; @endphp
    ...
    <table class="gen-table">
        ...
        <tbody>
            @for($i=1;$i<=5;$i++)
            <tr><td class="text-center">{{ $i }}.</td><td>-</td><td>-</td></tr>
            @endfor
        </tbody>
    </table>
    ...
    <table class="gen-table">
        ...
        <tbody>
            <tr><td class="text-center">1.</td><td>Sakit</td><td>{{ $catatan->sakit ?? '-' }} hari</td></tr>
            <tr><td class="text-center">2.</td><td>Izin</td><td>{{ $catatan->izin ?? '-' }} hari</td></tr>
            <tr><td class="text-center">3.</td><td>Tanpa Keterangan</td><td>{{ $catatan->alpa ?? '-' }} hari</td></tr>
        </tbody>
    </table>
    ...
    <table class="gen-table" style="margin-top:6px;">
        ...
        <tbody>
            <tr><td>Integritas</td><td>Ananda memiliki pola kehidupan kemasyarakatan yang tinggi di lingkungan sekolah.</td></tr>
            <tr><td>Religius</td><td>Ananda menunjukkan ketakwaan pada agama yang dianut dan toleran pada penganut agama yang berbeda.</td></tr>
            <tr><td>Nasionalis</td><td>Ananda bersikap, dan berbuat yang menunjukkan kesetiaan, kepedulian terhadap bahasa Indonesia di sekolah.</td></tr>
            <tr><td>Mandiri</td><td>Ananda sering membantu temannya di lingkungan sekolah.</td></tr>
            <tr><td>Gotong royong</td><td>Ananda menunjukkan sikap gotong-royong sebagai relawan dalam kegiatan kerja sosial.</td></tr>
        </tbody>
    </table>
